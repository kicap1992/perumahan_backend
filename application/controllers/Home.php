...
class Home extends CI_Controller
{
  ...
  {
    // print_r("ini home");
    // show the .svg file in assets folder
    $check_rumah = $this->model->tampil_data_keseluruhan('tb_rumah')->result();
    $file = 'assets/denah.svg';
  ...
  function coba() {
    $check_rumah = $this->model->tampil_data_keseluruhan('tb_rumah')->result();
    foreach ($check_rumah as $key) {
      $this->model->update('tb_rumah', array('id' => $key->id), array('pemilik' => 'Pemilik ' . $key->id));
    }
  }
